...
import TWMinigameSettingsModal from '../../containers/tw-minigame-settings-modal.jsx';
    ...
    return (<MediaQuery minWidth={unconstrainedWidth}>{isUnconstrained => {
        ...
        const alwaysEnabledModals = (
            <React.Fragment>
                ...
                {minigameSettingsModalVisible && <TWMinigameSettingsModal />}
...
GUIComponent.propTypes = {
    ...
    minigameSettingsModalVisible: PropTypes.bool,
